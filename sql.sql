/****** Object:  Database [FINALASS_FPOLY_NET_JAVA_SM22_BL2]    Script Date: 8/1/2022 11:11:47 PM ******/
CREATE DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2]

GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET ARITHABORT OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET AUTO_CLOSE ON 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET  ENABLE_BROKER 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET  MULTI_USER 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET DB_CHAINING OFF 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [FINALASS_FPOLY_NET_JAVA_SM22_BL2] SET QUERY_STORE = OFF
GO
USE [FINALASS_FPOLY_NET_JAVA_SM22_BL2]
GO
/****** Object:  Table [dbo].[Ban]    Script Date: 8/1/2022 11:11:48 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[ChucVu]    Script Date: 8/1/2022 11:11:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LoaiSP]    Script Date: 8/1/2022 11:11:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LoaiXM]    Script Date: 8/1/2022 11:11:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MoiQuanHe]    Script Date: 8/1/2022 11:11:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NhanVien]    Script Date: 8/1/2022 11:11:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NXB]    Script Date: 8/1/2022 11:11:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Sach]    Script Date: 8/1/2022 11:11:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SanPham]    Script Date: 8/1/2022 11:11:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[XeMay]    Script Date: 8/1/2022 11:11:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Ban__3214CC9EEFEFBAB6]    Script Date: 8/1/2022 11:11:48 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__ChucVu__3214CC9E69E34A96]    Script Date: 8/1/2022 11:11:48 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__LoaiSP__3214CC9EFF81B7BF]    Script Date: 8/1/2022 11:11:48 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__LoaiXM__3214CC9E0606C52F]    Script Date: 8/1/2022 11:11:48 PM ******/
ALTER TABLE [dbo].[LoaiXM] ADD UNIQUE NONCLUSTERED 
(
	[Ma] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__MoiQuanH__3214CC9ECF67AD31]    Script Date: 8/1/2022 11:11:48 PM ******/
ALTER TABLE [dbo].[MoiQuanHe] ADD UNIQUE NONCLUSTERED 
(
	[Ma] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__NhanVien__3214CC9E21200F2B]    Script Date: 8/1/2022 11:11:48 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__NXB__3214CC9E89EF0EEF]    Script Date: 8/1/2022 11:11:48 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Sach__3214CC9E5B5C2C75]    Script Date: 8/1/2022 11:11:48 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__SanPham__3214CC9E01251196]    Script Date: 8/1/2022 11:11:48 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__XeMay__3214CC9E722C7BA3]    Script Date: 8/1/2022 11:11:48 PM ******/
ALTER TABLE [dbo].[XeMay] ADD UNIQUE NONCLUSTERED 
(
	[Ma] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
